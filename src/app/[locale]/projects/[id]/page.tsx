...
export default async function ProjectPage({ params }: PageProps) {
  ...
  if (!isOwner) {
    ...
    hasImdbAccount = !!(
      userProfile?.imdb_profile_url && userProfile?.imdb_synced === true
    );
  }
          ...
          {!isOwner && hasImdbAccount && (
            <section className="glass-panel p-8 border-2 border-green-500/30">
              ...
              <p className="text-muted mb-6">
                Place a bid to work on this project as a verified industry
                professional.
              </p>
              <BidButton />
            </section>
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-4">
                {project.accolades.map((accolade) => (
                  <div
                    key={accolade.id}
                    className="glass-panel px-6 py-4 flex flex-col items-center text-center min-w-[140px]"
                  >
